...
public enum Collectible {
    LUCID_LILY(Mytems.LUCID_LILY, PICK_SWAMP_SEAGRASS) {
    ...
    PINE_CONE(Mytems.PINE_CONE, PICK_TAIGA_SPRUCE_LEAVES) {
        @Override public List<String> getBookPages() {
    ...
    ORANGE_ONION(Mytems.ORANGE_ONION, PICK_ORANGE_TULIP) {
        @Override public List<String> getBookPages() {
    ...
    MISTY_MOREL(Mytems.MISTY_MOREL, PICK_SWAMP_BROWN_MUSHROOM) {
        @Override public List<String> getBookPages() {
            return List.of("Large crowds comb through the woods every year to find this delicacy. They are usually easy to find in the shady woods.");
        }
    },
    RED_ROSE(Mytems.RED_ROSE, PICK_ROSE_BUSH) {
        @Override public List<String> getBookPages() {
            return List.of("It is a common misconception that they removed the red rose from the game in favor of the common poppy.");
        }
    },
    FROST_FLOWER(Mytems.FROST_FLOWER, PICK_COLD_TALL_GRASS) {
        @Override public List<String> getBookPages() {
    ...
    HEAT_ROOT(Mytems.HEAT_ROOT, PICK_DESERT_DEAD_BUSH) {
        @Override public List<String> getBookPages() {
    ...
    CACTUS_BLOSSOM(Mytems.CACTUS_BLOSSOM, PICK_CACTUS) {
        @Override public List<String> getBookPages() {
    ...
    PIPE_WEED(Mytems.PIPE_WEED, PICK_JUNGLE_FERN) {
        @Override public List<String> getBookPages() {
    ...
    KINGS_PUMPKIN(Mytems.KINGS_PUMPKIN, PICK_PUMPKIN) {
        @Override public List<String> getBookPages() {
            return List.of("There is a special kind of distinguished pumpkin, identifiable by it's crown-shaped leaves on top, hence the name.");
        }
    },
    SPARK_SEED(Mytems.SPARK_SEED, BUCKET_SURFACE_LAVA) {
        @Override public List<String> getBookPages() {
    ...
    OASIS_WATER(Mytems.OASIS_WATER, BUCKET_DESERT_WATER) {
        @Override public List<String> getBookPages() {
    ...
    CLAMSHELL(Mytems.CLAMSHELL, PICK_CORAL) {
        @Override public List<String> getBookPages() {
    ...
    FROZEN_AMBER(Mytems.FROZEN_AMBER, PICK_BLUE_OR_PACKED_ICE) {
        @Override public List<String> getBookPages() {
            return List.of("You may have heard that mosquitoes sometimes get frozen in Amber, to be conserved for millions of years.");
        }
    },
    CLUMP_OF_MOSS(Mytems.CLUMP_OF_MOSS, PICK_MOSSY_STONE) {
        @Override public List<String> getBookPages() {
            return List.of("Moss loves dark and moist spaces, so the woods are bound to be lousy with them.");
        }
    },
    FIRE_AMANITA(Mytems.FIRE_AMANITA, KILL_NETHER_PIGLIN) {
        @Override public List<String> getBookPages() {
            return List.of("Out of the frying pa-... never mind. So this fiery fungus grows in the depths of the Nether. This is by far the most dangerous place we are sending you to, so do be careful.");
        }
    };
